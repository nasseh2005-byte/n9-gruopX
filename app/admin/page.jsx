  ...
  return (
    <main className="wrap" style={{ padding: '40px 0' }}>
      <div className="section-title">
        <div>
          <h2>لوحة الإدارة الحقيقية</h2>
          <p>إدارة محتوى المنتجات والشركاء مع حفظ دائم محليًا، وتعديل وحذف فوري.</p>
        </div>
      ...
      <div className="grid cards" style={{ marginBottom: 18 }}>
        {stats.map((s) => (
          <div className="card" key={s.label}><span className="tag">{s.label}</span><h3 style={{ marginBottom: 0 }}>{s.value}</h3></div>
        ))}
      </div>
      ...
      <div className="grid cards" style={{ marginTop: 18 }}>
        <div className="card">
          ...
          <div className="info-list">
            {products.map((p) => (
              <div className="info-item" key={p.id}>
